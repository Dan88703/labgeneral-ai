...
export function AppHeader() {
    return (
        ...
        >
            {/* Ikona z literą "L" zamiast kolby — czarne tło, zgodnie z LABLogoBlack */}
            <div
            ...
            <div className="min-w-0 leading-tight">
                ...
                <div className="truncate text-xs text-white/70">/ {APP_SUBTITLE}</div>
            </div>

            <div className="ml-auto flex items-center gap-3">
                {/* Link do strony głównej stylizowany jak .cta_btn ze strony */}
                <a
                    href={SITE_URL}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="hidden items-center gap-1.5 px-3 py-1.5 text-xs font-semibold transition-transform hover:scale-105 sm:flex"
                    style={{
